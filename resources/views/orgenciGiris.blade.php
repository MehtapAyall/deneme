    ...
    <section class="koyu_arkaplan" id="hero" style=" background: url({{url('/resimler/arka.jpg')}});" >
      <div class="container">
        <div class="d-flex h-100 flex-column text-light justify-content-center" >
            ...
            <tr><td style="text-align:right;"><button class="btn btn-danger" onclick="location='/kayitOl'">Kayıt Ol</button></td><td><button type="submit"class="btn primary btn-warning" onclick="location='/ogrAnasayfa'" >Giriş Yap</button> </td></tr>
            </table></form>
        </div>
      </div>
    </section>
